...
router.get(`/posts/:username`, authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 1')
		return res.status(500).send('Server Error')
	}
})
...
router.get('/followers/:userId', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 5')
		return res.status(500).send('Server Error')
	}
})
...
router.get('/following/:userId', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 2')
		return res.status(500).send('Server Error')
	}
})
...
router.post('/follow/:userToFollowId', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 6')
		return res.status(500).send('Server Error')
	}
})
...
router.put('/unfollow/:userToUnfollowId', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 3')
...
router.post('/update', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 7')
		return res.status(500).send('Server Error')
	}
})
...
router.post('/settings/password', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 4')
		return res.status(500).send('Server Error')
	}
})
...
router.post('/settings/messagePopup', authMiddleware, async (req, res) => {
	try {
		...
		console.error(error + ' error is 8')
		return res.status(500).send('Server Error')
	}
})
